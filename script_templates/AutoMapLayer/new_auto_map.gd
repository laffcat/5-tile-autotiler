# meta-name: New AutoMap
# meta-description: Includes a blank get_tile() overwrite
# meta-default: true
# meta-space-indent: 4
@tool
...
func get_tile(neighbors : Array[bool] = [false, false, false, false]) -> Array:
	...
	match neighbors: ## data entry time!
		...
		# vertical edges - |▄▄|, |▀▀|
		[false, false, true, true]: return [ 0, 0, 0 ]
		[true, true, false, false]: return [ 0, 0, 0 ]
		# hortizontal edges - | █|, |█ |
		[false, true, true, false]: return [ 0, 0, 0 ]
		[true, false, false, true]: return [ 0, 0, 0 ]
		# top outer corners - | ▄|, |▄ |
		[false, false, true, false]: return [ 0, 0, 0 ]
		[false, false, false, true]: return [ 0, 0, 0 ]
		# bottom outer corners - | ▀|, |▀ |
		[false, true, false, false]: return [ 0, 0, 0 ]
		[true, false, false, false]: return [ 0, 0, 0 ]
		# top inner corners - |▄█|, |█▄|
		[false, true, true, true]: return [ 0, 0, 0 ]
		[true, false, true, true]: return [ 0, 0, 0 ]
		# bottom inner corners - |▀█|, |█▀|
		[true, true, true, false]: return [ 0, 0, 0 ]
		[true, true, false, true]: return [ 0, 0, 0 ]
		# diagonals - |▀▄|, |▄▀|
		[true, false, true, false]: return [ 0, 0, 0 ]
		[false, true, false, true]: return [ 0, 0, 0 ]
		# empty - |  |
