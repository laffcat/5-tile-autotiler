...
func get_tile(neighbors : Array[bool] = [false, false, false, false]) -> Array: 
	...
	match neighbors: ## data entry time!
		...
		# top inner corners - |▄█|, |█▄|
		[false, true, true, true]: return [ 0, 3, 0 ]
		[true, false, true, true]: return [ 1, 3, 0 ]
		# bottom inner corners - |▀█|, |█▀|
		[true, true, true, false]: return [ 0, 4, 0 ]
		[true, true, false, true]: return [ 1, 4, 0 ]
		# diagonals - |▀▄|, |▄▀|
		[true, false, true, false]: return [ 2, 3, 0 ]
		[false, true, false, true]: return [ 2, 4, 0 ]
		# empty - |  |
